...
// Add a ClientOnlyPortal component after the imports
// This component will render its children into a portal when the browser is available
                        ...
                        <ClientOnlyPortal>
                          <div className="fixed inset-0 z-[9999] bg-transparent pointer-events-none">
                            <div 
                              ...
                              style={{
                                top: statusButtonRef.current ? statusButtonRef.current.getBoundingClientRect().top - 260 + 'px' : '0',
                        ...
                        <ClientOnlyPortal>
                          <div className="fixed inset-0 z-[9999] bg-transparent pointer-events-none">
                            <div 
                              className="pointer-events-auto absolute"
                              style={{
                                top: paymentButtonRef.current ? paymentButtonRef.current.getBoundingClientRect().top - 260 + 'px' : '0',
                        ...
                        <ClientOnlyPortal>
                          <div className="fixed inset-0 z-[9999] bg-transparent pointer-events-none">
                            <div 
                              className="pointer-events-auto absolute"
                              style={{
                                top: dateButtonRef.current ? dateButtonRef.current.getBoundingClientRect().top - 350 + 'px' : '0',
